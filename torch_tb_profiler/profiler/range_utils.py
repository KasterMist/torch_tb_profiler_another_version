...
def subtract_ranges_lists(range_list1: List[Tuple[int, int]],
    ...
    while i1 < len(range_list1):
        ...
        # r2 start <= r1 start and r2 end >= r1 end
            ...
            r2 = (r1[1], r2[1])
            r1, i1 = pop_list(range_list1, i1)
        # r2 start < r1 end and r2 start > r1 start
        elif r2[0] < r1[1]:
            assert (r2[0] > r1[0])
...
# get the sum of the ranges in the list
...
# get the next item in the list and the next index
...
# merge ranges in src_ranges and return the merged ranges.
