...
class RunProfileData(object):
    ...
    def process(self):
        ...
        with utils.timing('OverallParser aggegation'):
            ...
            # print("before self.avg_costs.costs[4]", overall_parser.avg_costs.costs[4])
            overall_parser.aggregate(parser.steps, parser.role_ranges)
            # sums = 0
            # for i in parser.role_ranges[4]:
            #     sums += i[1] - i[0]
            # print(sums)
        ...
        # print("after self.avg_costs.costs[4]", overall_parser.avg_costs.costs[4])
